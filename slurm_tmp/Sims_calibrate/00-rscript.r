...
TMP_PATH  <- "/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp"
...
tcq({
  ...
  library(future, lib.loc = "/uufs/chpc.utah.edu/sys/installdir/r8/RLibs/4.4.0")
  library(future.apply, lib.loc = "/uufs/chpc.utah.edu/sys/installdir/r8/RLibs/4.4.0")
...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/mc.cores.rds")
})
tcq({
  simulate_and_calibrate <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/simulate_and_calibrate.rds")
})
tcq({
  simulate_epidemic_observed <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/simulate_epidemic_observed.rds")
})
tcq({
  simulate_epidemic_calib <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/simulate_epidemic_calib.rds")
})
tcq({
  simulation_fun <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/simulation_fun.rds")
})
tcq({
  summary_fun <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/summary_fun.rds")
})
tcq({
  proposal_fun <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/proposal_fun.rds")
})
tcq({
  kernel_fun <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/kernel_fun.rds")
})
tcq({
  theta_use <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/theta_use.rds")
})
tcq({
  model_ndays <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/model_ndays.rds")
})
tcq({
  model_seed <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/model_seed.rds")
})
tcq({
  global_n <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/global_n.rds")
})
tcq({
  N_SIMS <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/N_SIMS.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurm_tmp/Sims_calibrate/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
