...
JOB_NAME  <- "bias_coverage_analysis"
...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/mc.cores.rds")
})
tcq({
  run_parameter_set <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/run_parameter_set.rds")
})
tcq({
  params_all <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/params_all.rds")
})
tcq({
  n_runs <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/n_runs.rds")
})
tcq({
  ndays <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/ndays.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_analysis/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
