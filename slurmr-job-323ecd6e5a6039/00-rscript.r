...
JOB_NAME  <- "slurmr-job-323ecd6e5a6039"
...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/mc.cores.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/slurmr-job-323ecd6e5a6039/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
