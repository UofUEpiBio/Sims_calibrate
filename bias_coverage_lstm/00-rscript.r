...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/mc.cores.rds")
})
tcq({
  run_parameter_set_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/run_parameter_set_method.rds")
})
tcq({
  run_lstm_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/run_lstm_method.rds")
})
tcq({
  params_all <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/params_all.rds")
})
tcq({
  n_runs <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/n_runs.rds")
})
tcq({
  ndays <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/ndays.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_lstm/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
