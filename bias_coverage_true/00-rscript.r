...
tcq({
  ...
  library(purrr, lib.loc = "/uufs/chpc.utah.edu/common/home/u1418987/R/x86_64-pc-linux-gnu-library/4.4")
...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/mc.cores.rds")
})
tcq({
  run_parameter_set_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/run_parameter_set_method.rds")
})
tcq({
  run_true_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/run_true_method.rds")
})
tcq({
  params_all <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/params_all.rds")
})
tcq({
  n_runs <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/n_runs.rds")
})
tcq({
  ndays <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/ndays.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/Desktop/Sims_calibrate/bias_coverage_true/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
